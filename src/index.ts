...
export class Boom extends Error {
	public readonly isBoom = true
	public readonly isServer: boolean
	public readonly data: unknown
	public readonly output: BoomOutput

	constructor(message?: string, options: BoomOptions = {}) {
		super(message)
